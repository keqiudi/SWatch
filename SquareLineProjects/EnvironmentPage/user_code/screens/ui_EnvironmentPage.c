...
void ui_EnvironmentPage_screen_init(void)
{
    ...
    ui_TempIconLabel = lv_label_create(ui_EnvironmentPage);
    lv_obj_set_width(ui_TempIconLabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_TempIconLabel, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_TempIconLabel, -43);
    lv_obj_set_y(ui_TempIconLabel, -82);
    lv_obj_set_align(ui_TempIconLabel, LV_ALIGN_CENTER);
    lv_label_set_text(ui_TempIconLabel, "");
    lv_obj_set_style_text_color(ui_TempIconLabel, lv_color_hex(0xCC3031), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_TempIconLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_TempIconLabel, &ui_font_EPiconfont30, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_HumIconLabel = lv_label_create(ui_EnvironmentPage);
    lv_obj_set_width(ui_HumIconLabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_HumIconLabel, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_HumIconLabel, 42);
    lv_obj_set_y(ui_HumIconLabel, -84);
    lv_obj_set_align(ui_HumIconLabel, LV_ALIGN_CENTER);
    lv_label_set_text(ui_HumIconLabel, "");
    lv_obj_set_style_text_color(ui_HumIconLabel, lv_color_hex(0x2195F6), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_HumIconLabel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_HumIconLabel, &ui_font_EPiconfont30, LV_PART_MAIN | LV_STATE_DEFAULT);
